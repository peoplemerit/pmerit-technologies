...
Before using AIXORD with any AI platform, ensure you have:
...
AIXORD works with any conversational AI that can follow instructions. This Starter Guide provides quick-start files for:

| Platform | Provider | Quick-Start File |
|----------|----------|------------------|
| ChatGPT | OpenAI | AIXORD_CHATGPT_FREE.md |
| Claude | Anthropic | AIXORD_CLAUDE_FREE.md |
| Gemini | Google | AIXORD_GEMINI_FREE.md |

The Universal Governance file works with any AI platform. Platform-specific packs with additional features are available separately.
...
1. Read Chapter 9 (Setup) for your specific platform
...
**Part III: Getting Started with Any AI**
9. Setting Up for Any AI Platform
...
- Appendix B: Download Your Templates (discount code: AX-STR-7K9M)
- About the Author
...
The AI will guide you through reconstruction:
...
After providing information, the AI will show a recovery summary for confirmation before continuing.

### Prevention Tips

1. Save HANDOFFs immediately when the AI generates them
...
This chapter covers setup for ChatGPT, Claude, Gemini, and other AI platforms. The universal governance file works with any conversational AI.

---

## Universal Setup (Works with Any AI)

The AIXORD Universal Governance file works with any AI platform that can follow instructions. This paste-every-session method is reliable across all platforms.
...
1. Go to your AI platform (ChatGPT, Claude, Gemini, etc.)
2. Start a new conversation

**Step 2: Activate AIXORD**
1. Open your `ACTIVATION_TEMPLATE.txt`
2. Open `AIXORD_GOVERNANCE_UNIVERSAL_V3.3.md`
3. In the template, replace `[PASTE GOVERNANCE HERE]` with the entire governance content
4. Paste the combined text into the AI
5. Send the message

**Step 3: Wait for Confirmation**
- The AI should respond: "AIXORD ACTIVATED"
- If it doesn't, start a new conversation and try again

**Step 4: Continue Your Project**
1. Type: `PMERIT CONTINUE`
2. First time: Enter your license email or code
3. If continuing a project, paste your most recent HANDOFF
4. Start working!
...
2. Copy the entire handoff document the AI generates
...
Your download includes quick-start guides for popular platforms:

| File | Platform | Features |
|------|----------|----------|
| AIXORD_CHATGPT_FREE.md | OpenAI ChatGPT | Free tier setup |
| AIXORD_CLAUDE_FREE.md | Anthropic Claude | Free tier setup |
| AIXORD_GEMINI_FREE.md | Google Gemini | Free tier setup |

These guides are for YOU to read—they contain platform-specific tips and instructions. Do NOT paste these into the AI. Paste the Universal Governance file instead.
...
|----------|-----------|----------|
| ChatGPT | Custom GPTs (Plus/Pro), wide knowledge | General projects, coding |
| Claude | Long context, careful reasoning | Complex analysis, writing |
| Gemini | Google integration, multimodal | Research, Google Workspace |

AIXORD works identically across all platforms. Choose based on your preferences and available subscriptions.
...
1. New conversation → Paste governance → Wait for "AIXORD ACTIVATED"
...
When you unzip `aixord-starter.zip`, you'll find 10 files. Here's what each one does and when to use it.
...
| File | For | Purpose |
|------|-----|---------|
| `AIXORD_CHATGPT_FREE.md` | ChatGPT users | ChatGPT-specific setup instructions |
| `AIXORD_CLAUDE_FREE.md` | Claude users | Claude-specific setup instructions |
| `AIXORD_GEMINI_FREE.md` | Gemini users | Gemini-specific setup instructions |

**Important:** These guides teach you HOW to use AIXORD on each platform. They are instruction manuals for YOU to read. Do NOT paste these guide files into the AI. Paste `AIXORD_GOVERNANCE_UNIVERSAL_V3.3.md` instead.
...
```
Which file do I paste into the AI?
│
├─► ALWAYS paste: AIXORD_GOVERNANCE_UNIVERSAL_V3.3.md
│
└─► NEVER paste: AIXORD_CHATGPT_FREE.md, AIXORD_CLAUDE_FREE.md, or AIXORD_GEMINI_FREE.md
                 (These are guides for YOU to read, not for the AI)
```
...
When you first activate AIXORD (after license validation), the AI will ask:
...
**Verification Required:** After creating this structure, you'll upload a screenshot. The AI will verify each folder exists before proceeding. This ensures you're set up for success.
...
- The AI reminds you to save HANDOFFs but doesn't verify
...
|-------------------------------|-------------|--------|
| `# AIXORD GOVERNANCE` | Governance file | Paste this into the AI |
| `# AIXORD for ChatGPT` | Quick-start guide | Don't paste — read it instead |
| `# AIXORD for Claude` | Quick-start guide | Don't paste — read it instead |
| `# AIXORD for Gemini` | Quick-start guide | Don't paste — read it instead |
...
2. Start a new conversation
3. Paste the activation template + governance (see Chapter 9)
...
The AI will ask for your license email (first time only) and ask what you want to work on.
...
The AI will ask discovery questions to surface your project from frustrations, wishes, and repetitive tasks.

## Step 4: Brainstorm

Once you have a project direction, the AI enters BRAINSTORM mode:
...
Answer each question. The AI documents your answers.

## Step 5: Options

After brainstorming, the AI presents 2-3 solution approaches:
...
The AI generates your PROJECT DOCUMENT with:
...
With the document approved, the AI guides implementation:

- Provides step-by-step instructions
- Tracks progress through the DAG
- Verifies each deliverable against specifications
...
The AI generates a handoff document. Save it for your next session.
...
**Q: Does AIXORD work with any AI?**
A: Yes! AIXORD works with any conversational AI that can follow instructions. The Universal Governance file is platform-agnostic. Platform-specific packs provide additional features for specific platforms.

**Q: Why do I have to paste the governance every time?**
A: AI assistants don't have memory between sessions. The paste method ensures AIXORD governance is active each session. Some platforms (like ChatGPT Plus/Pro) support persistent instructions through Custom GPTs—see platform-specific guides.

**Q: Can I switch between AI platforms?**
A: Yes! Your HANDOFF files are platform-independent. You can start a project in ChatGPT, continue it in Claude, and finish in Gemini. Just paste the governance + HANDOFF in each new session.

**Q: The AI said "I don't understand PMERIT" — what happened?**
A: This means the governance wasn't properly loaded. Start a new conversation and paste the full activation template + governance. Make sure you include the entire governance file, not just part of it.

**Q: Can I have multiple AIXORD projects?**
A: Yes! Use separate HANDOFF files for each project. Name them descriptively (e.g., `HANDOFF_WebsiteProject_2025-01-15.md`).

**Q: What's the Proactive HANDOFF System?**
A: In v3.3, the AI automatically monitors context usage and generates HANDOFFs before the session runs out of space. You don't need to remember to request a HANDOFF—the AI tracks this for you. At ~80% context usage, it will proactively generate a HANDOFF for you to save.

**Q: My session ended without a HANDOFF. What do I do?**
A: Use the recovery command in a new session:
1. Start a new conversation and paste governance
...
4. The AI will reconstruct context and confirm before continuing
...
| **AIXORD_CHATGPT_FREE.md** | Setup guide for ChatGPT |
| **AIXORD_CLAUDE_FREE.md** | Setup guide for Claude |
| **AIXORD_GEMINI_FREE.md** | Setup guide for Gemini |
...
2. Open your preferred AI platform (ChatGPT, Claude, Gemini, etc.)
3. Start a new conversation
4. Paste the activation template + governance file
5. Wait for "AIXORD ACTIVATED"
6. Type: `PMERIT CONTINUE`
...
*Version 3.3 — January 2026 (Starter Edition)*
