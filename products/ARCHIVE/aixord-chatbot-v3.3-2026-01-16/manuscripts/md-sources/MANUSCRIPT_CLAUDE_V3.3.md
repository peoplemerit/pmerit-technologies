...
Before using AIXORD with Claude, ensure you have:

## Basic Requirements (All Users)

| Requirement | Why |
|-------------|-----|
| Anthropic account | Required to access Claude |
...
## Understanding Your Claude Tier

### Claude Pro ($20/month)

If you subscribe to Claude Pro, you have access to:

- **Projects** — Organize conversations with persistent instructions and knowledge
- **Extended context** — Longer conversations without losing track
- **Priority access** — During high-traffic periods
- **File uploads** — Upload documents for reference

**AIXORD Experience:** Create a Claude Project once, use it forever. No pasting governance every session.

### Claude Pro + Claude Code

If you use Claude Pro along with Claude Code (the CLI tool):

- **Projects** — Same as Pro for web conversations
- **Claude Code** — AI-powered coding assistant in your terminal
- **File system access** — Claude can read and edit files directly
- **Integrated workflow** — Seamless between planning and implementation

**AIXORD Experience:** Best of both worlds—Projects for planning, Claude Code for execution.

### Claude Free

If you use Claude without a paid subscription:
...
**Claude Project** — A workspace in Claude Pro with persistent instructions and knowledge that persists across sessions.
...
**Part III: Getting Started with Claude**
9. Setting Up for Claude
...
- Appendix B: Download Your Templates (discount code: AX-CLD-8N5Q)
- About the Author
...
| **Architect** | Claude | Analyzes, questions, plans, specifies, produces HANDOFFs. |
...
**DISCOVER** — Guided exploration when you do not have a clear project idea. Claude asks targeted questions about your interests, skills, and constraints to generate viable project candidates.
...
- Claude knows whether to explore possibilities or execute plans
- Progress is measurable and verifiable

When Claude displays its response header, you will always see which kingdom you are in. This constant reminder helps maintain the discipline that makes AI collaboration productive.
...
During the ASSESS phase in the Ideation Kingdom, before you can pass the Ideation Gate, Claude helps you map your project into a DAG. Each deliverable becomes a SCOPE with:
...
The DAG determines execution order. When you enter the Realization Kingdom, Claude identifies which SCOPEs have no unmet dependencies. These are eligible to start. As each SCOPE is verified complete, new SCOPEs become eligible.
...
Claude will note these opportunities: "SCOPE_WEB and SCOPE_MOBILE can proceed in parallel. Which would you like to start?"
...
During BRAINSTORM and OPTIONS phases, Claude evaluates proposed approaches against these dimensions. Each dimension receives a status:
...
Claude will display a table showing each dimension, its assessment, and any notes. This makes quality visible and discussable rather than implicit and assumed.
...
When Claude recommends a Priority 4 or 5 solution, it must provide justification: what capability does this provide that lower-priority options cannot match? This prevents defaulting to expensive solutions when simpler alternatives exist.
...
## Proactive HANDOFF System (Claude-Specific)

**You don't need to remember to request HANDOFFs.** With v3.3, Claude tracks context usage and generates HANDOFFs automatically.

### How It Works

Claude monitors the conversation and acts at key thresholds:

| Context Level | What Claude Does |
|---------------|------------------|
...
Claude will also generate HANDOFFs when:
...
When Claude generates a HANDOFF:
...
Claude will guide you through reconstruction:
...
After providing information, Claude will show a recovery summary for confirmation before continuing.

### Prevention Tips

1. Save HANDOFFs immediately when Claude generates them
2. Keep your PROJECT_DOCUMENT.md updated
3. Use `PMERIT CHECKPOINT` for mid-session saves during long work

\newpage

# Chapter 9: Setting Up for Claude

This chapter covers setup for Claude Pro and Claude Free users. Find your tier and follow those instructions.

---

## Part A: Claude Pro Setup (Recommended)

If you have Claude Pro, you can create a **Claude Project** — a workspace with your governance rules built in. This is a one-time setup that makes every future session instant.

### What Are Claude Projects?

Claude Projects are workspaces in Claude Pro. Each Project has:
- **Project Instructions** — Rules Claude follows (where your AIXORD governance goes)
- **Project Knowledge** — Files Claude can reference (your project documents)
- **Name & Description** — For easy identification

Think of a Project as your personal AIXORD assistant that remembers its training.

### Creating Your AIXORD Project
...
2. **Project Instructions:** This is the important part
   - Open `AIXORD_GOVERNANCE_CLAUDE_PROJECT_V3.3.md` from your download (the condensed version)
...
2. Upload these files:
   ...
   - `AIXORD_STATE_CLAUDE_V3.3.json` (state template)
   - Previous HANDOFF files
   - Project requirements
   - Reference materials
3. Claude will reference these during conversations

### Which Governance File for Projects?

Your download includes two governance files:

| File | Size | Purpose |
|------|------|---------|
| `AIXORD_GOVERNANCE_CLAUDE_PROJECT_V3.3.md` | ~13KB | Optimized for Project Instructions |
| `AIXORD_GOVERNANCE_CLAUDE_V3.3.md` | ~79KB | Full version for paste workflow |

**For Project users:** Use the condensed `_PROJECT_V3.3.md` file in Instructions. It's optimized to fit within Claude's limits while retaining all essential functionality.

**Upload to Knowledge:**
- `AIXORD_PHASE_DETAILS_V3.3.md` — Detailed phase behaviors
- `AIXORD_STATE_CLAUDE_V3.3.json` — State tracking template
- Your project files as you create them

**Why two files?**

Claude's Project Instructions has content limits that occasionally reject larger files. The condensed version (~13KB) fits reliably. The full version (~79KB) is for users who prefer the paste-every-session workflow or need the complete v3.3 features.

### Troubleshooting Project Save Issues

If you have trouble saving your Project:

1. **Try the condensed file** — Use `AIXORD_GOVERNANCE_CLAUDE_PROJECT_V3.3.md` instead of the full version
2. **Check for special characters** — Remove any unusual symbols
3. **Try smaller chunks** — Paste half, save, then add the rest
4. **Use paste workflow** — If Projects won't work, use the paste method (see Claude Free setup)

The condensed file has been tested to save successfully in most cases.

**Step 4: Save**
1. Click "Create Project"
2. Your AIXORD Project appears in the Projects sidebar
3. Done! One-time setup complete.

### Using Your AIXORD Project

**Every Session:**
1. Click your AIXORD Project in the sidebar
2. Type: `PMERIT CONTINUE`
3. First time: Enter your license email or code
4. When asked about tier, say: `Project`
5. Start working!
...
## Part B: Claude Free Setup

Without the Projects feature, you'll paste the governance document at the start of each session. It takes about 2 minutes.
...
2. Open `AIXORD_GOVERNANCE_CLAUDE_V3.3.md`
3. In the template, replace `[PASTE GOVERNANCE HERE]` with the entire governance content
4. Paste the combined text into Claude
5. Send the message

**Step 3: Wait for Confirmation**
- Claude should respond: "AIXORD ACTIVATED"
...
2. Copy the entire handoff document Claude generates
...
4. **Consider upgrading** — If you use AIXORD regularly, Projects are worth it
...
### Claude Pro (Project)
1. Create AIXORD Project (one-time, 5 min)
2. Open Project → `PMERIT CONTINUE` → Work
...
|------|---------|-------------|
| `AIXORD_GOVERNANCE_CLAUDE_V3.3.md` | Main governance framework (79KB) | Paste into Claude to activate AIXORD |
| `AIXORD_GOVERNANCE_CLAUDE_PROJECT_V3.3.md` | Condensed version (13KB) | Use in Project Instructions |
| `AIXORD_STATE_CLAUDE_V3.3.json` | State tracking template | Save session progress |
| `AIXORD_PHASE_DETAILS_V3.3.md` | Extended phase behaviors | Reference during sessions |
| `PURPOSE_BOUND_OPERATION_SPEC.md` | Core v3.3 specification | Reference for governance rules |

## Tier-Specific Setup Guides

| File | For |
|------|-----|
| `AIXORD_CLAUDE_PRO.md` | Claude Pro subscribers ($20/mo) |
| `AIXORD_CLAUDE_DUAL.md` | Claude Pro + Claude Code users |
| `AIXORD_CLAUDE_FREE.md` | Claude Free users |
...
| File | Purpose |
|------|---------|
| `DISCLAIMER.md` | Legal terms and conditions - READ BEFORE USING |
| `LICENSE.md` | Usage rights and permissions |
| `LICENSE_KEY.txt` | Your license certificate confirming authorized purchase |
...
When you first activate AIXORD (after license validation), Claude will ask:
...
- Claude reminds you to save HANDOFFs but doesn't verify
...
|-------------------------------|-------------|--------|
| `# AIXORD GOVERNANCE` | Governance file | Paste this into Claude |
| `# AIXORD for Claude Pro` | Quick-start guide | Don't paste — read it instead |
| `# AIXORD for Claude + Code` | Quick-start guide | Don't paste — read it instead |
| `# AIXORD for Claude Free` | Quick-start guide | Don't paste — read it instead |

The governance file is approximately 79KB. The quick-start guides are smaller (4-7KB).
...
**Claude Pro Users:**
1. Create your AIXORD Project (see Chapter 9, Part A)
2. Open the Project from the sidebar
...
- Tier A (Project): Claude provides guidance with persistent context
- Tier B (Pro): Claude provides step-by-step instructions
...
## Claude-Specific FAQs

**Q: What are Claude Projects and do I need them?**
A: Claude Projects are workspaces available to Claude Pro subscribers ($20/month). They let you set persistent instructions so you don't have to paste the governance file every session. If you have Pro, use Projects — it's a much better experience.

**Q: Why do I have to paste the governance every time on Free?**
A: Claude Free doesn't support Projects. The only way to give Claude rules is by including them in your message. The paste method ensures AIXORD governance is active each session.

**Q: Can I switch between Claude Free and Pro?**
A: Yes! If you upgrade to Pro, create an AIXORD Project and you're set. Your existing HANDOFF files will still work — just paste them when Claude asks for context.

**Q: Claude said "I don't understand PMERIT" — what happened?**
A: This means the governance wasn't properly loaded. For Free users: start a new chat and paste the full activation template + governance. For Pro users: make sure you're in your AIXORD Project, not regular chat.

**Q: Can I have multiple AIXORD projects?**
A: Yes!
- **Pro:** Create one Project per project (e.g., "AIXORD - Website", "AIXORD - App")
- **Free:** Use separate HANDOFF files for each project

**Q: How do I add files to my Claude Project?**
A: In Claude Pro:
1. Open your AIXORD Project settings
2. Go to the Project Knowledge section
3. Click "Add content"
4. Upload your documents (PDF, DOCX, MD, TXT)
5. Save the Project

**Q: What's the difference between Project Instructions and Knowledge?**
A:
...
A: In v3.3, Claude automatically monitors context usage and generates HANDOFFs before the session runs out of space. You don't need to remember to request a HANDOFF — Claude tracks this for you. At ~80% context usage, Claude will proactively generate a HANDOFF for you to save.
...
4. Claude will reconstruct context and confirm before continuing
...
A: If you use Claude Code (the CLI tool), you get the best of both worlds:
- Use Claude Projects for planning and brainstorming
- Use Claude Code for implementation (it can read and edit files directly)
- See the AIXORD_CLAUDE_DUAL.md guide for the combined workflow
...
**Product:** AIXORD Claude Pack
**Regular Price:** $7.99
**Your Price:** FREE (with code)
**URL:** https://meritwise0.gumroad.com/l/aixord-claude

## How to Download

1. Visit the URL above (or type it into your browser)
2. Click "I want this!"
3. Enter the discount code: AX-CLD-8N5Q
...
| File | Purpose |
|------|---------|
| **AIXORD_GOVERNANCE_CLAUDE_V3.3.md** | Main governance file (full version) |
| **AIXORD_GOVERNANCE_CLAUDE_PROJECT_V3.3.md** | Condensed governance for Project Instructions |
| **AIXORD_PHASE_DETAILS_V3.3.md** | Detailed phase behaviors |
| **AIXORD_STATE_CLAUDE_V3.3.json** | State tracking template |
| **PURPOSE_BOUND_OPERATION_SPEC.md** | Core v3.3 Purpose-Bound specification |
| **AIXORD_CLAUDE_PRO.md** | Setup guide for Claude Pro |
| **AIXORD_CLAUDE_DUAL.md** | Setup guide for Claude Pro + Code |
| **AIXORD_CLAUDE_FREE.md** | Setup guide for Claude Free |
...
2. Open claude.ai → Projects → New Project
3. Name it "AIXORD"
4. Paste AIXORD_GOVERNANCE_CLAUDE_PROJECT_V3.3.md into Project Instructions
5. Upload AIXORD_PHASE_DETAILS_V3.3.md to Project Knowledge
6. Save the Project
7. Open your Project and type: `PMERIT CONTINUE`
...
*Version 3.3 — January 2026 (Claude Edition)*
