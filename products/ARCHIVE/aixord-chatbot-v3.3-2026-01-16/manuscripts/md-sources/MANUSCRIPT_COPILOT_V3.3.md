...
Before using AIXORD with Copilot, ensure you have:

## Basic Requirements (All Users)

| Requirement | Why |
|-------------|-----|
| Microsoft account | Required to access Copilot |
...
## Understanding Your Copilot Tier

### Microsoft 365 Copilot (Enterprise)

If your organization has Microsoft 365 Copilot:

- **Full integration** — Works inside Word, Excel, PowerPoint, Outlook, Teams
- **Enterprise context** — Access to your organization's data
- **Advanced features** — Document generation, meeting summaries, email drafting
- **IT-managed** — Your organization controls settings

**AIXORD Experience:** Paste governance at session start in Copilot chat. Enterprise features enhance productivity.

### Copilot Pro ($20/month)

If you subscribe to Copilot Pro:

- **Priority access** — During high-traffic periods
- **GPT-4 Turbo** — Latest model access
- **Office integration** — Works in Word, Excel, PowerPoint (with M365 subscription)
- **Image generation** — Enhanced Designer features

**AIXORD Experience:** Paste governance at session start. Best balance of features and cost.

### Copilot Free

If you use Copilot without a paid subscription:
...
- Microsoft 365 subscription (though it helps)
...
**Part III: Getting Started with Copilot**
9. Setting Up for Copilot
...
- Appendix B: Download Your Templates (discount code: AX-CPL-9V2H)
- About the Author
...
| **Architect** | Copilot | Analyzes, questions, plans, specifies, produces HANDOFFs. |
...
**DISCOVER** — Guided exploration when you do not have a clear project idea. Copilot asks targeted questions about your interests, skills, and constraints to generate viable project candidates.
...
- Copilot knows whether to explore possibilities or execute plans
- Progress is measurable and verifiable

When Copilot displays its response header, you will always see which kingdom you are in. This constant reminder helps maintain the discipline that makes AI collaboration productive.
...
During the ASSESS phase in the Ideation Kingdom, before you can pass the Ideation Gate, Copilot helps you map your project into a DAG. Each deliverable becomes a SCOPE with:
...
The DAG determines execution order. When you enter the Realization Kingdom, Copilot identifies which SCOPEs have no unmet dependencies. These are eligible to start. As each SCOPE is verified complete, new SCOPEs become eligible.
...
Copilot will note these opportunities: "SCOPE_WEB and SCOPE_MOBILE can proceed in parallel. Which would you like to start?"
...
During BRAINSTORM and OPTIONS phases, Copilot evaluates proposed approaches against these dimensions. Each dimension receives a status:
...
Copilot will display a table showing each dimension, its assessment, and any notes. This makes quality visible and discussable rather than implicit and assumed.
...
When Copilot recommends a Priority 4 or 5 solution, it must provide justification: what capability does this provide that lower-priority options cannot match? This prevents defaulting to expensive solutions when simpler alternatives exist.
...
**You don't need to remember to request HANDOFFs.** With v3.3, Copilot tracks context usage and generates HANDOFFs automatically.

### How It Works

Copilot monitors the conversation and acts at key thresholds:

| Context Level | What Copilot Does |
|---------------|-------------------|
...
Copilot will also generate HANDOFFs when:
...
When Copilot generates a HANDOFF:
...
Copilot will guide you through reconstruction:
...
After providing information, Copilot will show a recovery summary for confirmation before continuing.

### Prevention Tips

1. Save HANDOFFs immediately when Copilot generates them
...
This chapter covers setup for all Copilot tiers. Since Copilot doesn't have persistent custom instructions like some other AI platforms, all users follow a similar paste-based workflow.
...
3. You'll see the Copilot chat interface

### Windows Integration

If you use Windows 11:
- Press Win + C to open Copilot sidebar
- Or click the Copilot icon in the taskbar

### Edge Browser

- Click the Copilot icon in the Edge sidebar
- Or press Ctrl + Shift + . (period)

### Mobile Apps

- Download Microsoft Copilot from App Store or Google Play
...
Since Copilot doesn't have persistent custom instructions, you'll paste the governance document at the start of each session.
...
**Step 1: Open Copilot**
- Go to copilot.microsoft.com, or
- Open Copilot in Windows/Edge

**Step 2: Activate AIXORD**
1. Open your `ACTIVATION_TEMPLATE.txt`
2. Open `AIXORD_GOVERNANCE_COPILOT_V3.3.md`
3. In the template, replace `[PASTE GOVERNANCE HERE]` with the entire governance content
4. Paste the combined text into Copilot
5. Send the message

**Step 3: Wait for Confirmation**
- Copilot should respond: "AIXORD ACTIVATED"
...
3. When asked about tier, say your Copilot version (Free, Pro, or M365)
...
2. Copy the entire handoff document Copilot generates
...
If you have M365 Copilot through your organization:
- You can use AIXORD in the Copilot chat interface
- Document generation features in Word/Excel work alongside AIXORD
- Ask your IT admin about any usage policies

### Copilot Pro Users

- You get priority access and better model performance
- Office integration (if you have M365) works well with AIXORD workflows
- Consider keeping governance file in OneDrive for easy access

### Copilot Free Users

- You may hit usage limits during peak times
- Keep sessions focused to work within limits
- HANDOFF documents are essential for continuity
...
|------|---------|-------------|
| `AIXORD_GOVERNANCE_COPILOT_V3.3.md` | Main governance framework (81KB) | Paste into Copilot at session start |
| `AIXORD_STATE_COPILOT_V3.3.json` | State tracking template | Save session progress |
...
| File | For |
|------|-----|
| `AIXORD_COPILOT.md` | All Copilot users (Free, Pro, M365) |
...
When you first activate AIXORD (after license validation), Copilot will ask:
...
- Copilot reminds you to save HANDOFFs but doesn't verify
...
|-------------------------------|-------------|--------|
| `# AIXORD GOVERNANCE` | Governance file | Paste this into Copilot |
| `# AIXORD for Copilot` | Quick-start guide | Don't paste — read it instead |

The governance file is approximately 81KB. The quick-start guide is smaller (~5KB).
...
1. Open copilot.microsoft.com (or Windows/Edge Copilot)
2. Paste the activation template + governance (see Chapter 9)
...
Copilot will ask for your license email (first time only), detect your tier, and ask what you want to work on.
...
Copilot will ask discovery questions to surface your project from frustrations, wishes, and repetitive tasks.

## Step 4: Brainstorm

Once you have a project direction, Copilot enters BRAINSTORM mode:
...
Answer each question. Copilot documents your answers.

## Step 5: Options

After brainstorming, Copilot presents 2-3 solution approaches:
...
Copilot generates your PROJECT DOCUMENT with:
...
With the document approved, Copilot guides implementation:

- Provides step-by-step instructions
- Generates code snippets
- Creates document outlines
- Tracks progress through the DAG
...
Copilot generates a handoff document. Save it for your next session.
...
## Copilot-Specific FAQs

**Q: Does Copilot support custom instructions like other AI platforms?**
A: Not in the same way. Copilot doesn't have persistent "Custom GPTs" or "Projects." You need to paste the governance file at the start of each session. The HANDOFF system compensates for this by preserving your context between sessions.

**Q: Why do I have to paste the governance every time?**
A: Copilot doesn't retain custom instructions between sessions. The paste method ensures AIXORD governance is active each session. It takes about 2 minutes but ensures consistent behavior.

**Q: Can I use AIXORD with Microsoft 365 Copilot in Word/Excel?**
A: AIXORD is designed for the Copilot chat interface. When using Copilot features inside Office apps (like "Draft with Copilot" in Word), the governance won't be active. Use the chat interface for AIXORD sessions, then use the document generation for specific outputs.

**Q: Copilot said "I don't understand PMERIT" — what happened?**
A: This means the governance wasn't properly loaded. Start a new chat and paste the full activation template + governance. Make sure you paste the entire `AIXORD_GOVERNANCE_COPILOT_V3.3.md` file.

**Q: Can I have multiple AIXORD projects?**
A: Yes! Use separate HANDOFF files for each project. When starting a session, paste the governance plus the HANDOFF for whichever project you're working on.

**Q: Is Copilot Pro worth it for AIXORD?**
A: Copilot Pro gives you:
- Priority access (fewer "busy" errors)
- Better model performance
- Office integration (if you have M365)

If you use AIXORD frequently, Pro reduces friction. Free works fine for occasional use.

**Q: What about the Windows Copilot sidebar?**
A: You can use AIXORD in the Windows sidebar, but the web interface at copilot.microsoft.com typically provides a better experience for longer sessions.
...
4. Copilot will reconstruct context and confirm before continuing
...
│  Architect (Copilot) → Plans and specifies                  │
...
**URL:** https://meritwise0.gumroad.com/l/aixord-copilot

## How to Download

1. Visit the URL above (or type it into your browser)
2. Click "I want this!"
3. Enter the discount code: AX-CPL-9V2H
...
| File | Purpose |
|------|---------|
| **AIXORD_GOVERNANCE_COPILOT_V3.3.md** | Main governance file |
| **AIXORD_STATE_COPILOT_V3.3.json** | State tracking template |
| **PURPOSE_BOUND_OPERATION_SPEC.md** | Core v3.3 Purpose-Bound specification |
| **AIXORD_COPILOT.md** | Setup guide for all Copilot tiers |
...
2. Open copilot.microsoft.com → New Chat
...
*Version 3.3 — January 2026 (Copilot Edition)*
