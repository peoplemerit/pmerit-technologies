# AIXORD GOVERNANCE — ChatGPT GPT Edition (v3.2.1)

**Version:** 3.2.1 | **Platform:** OpenAI ChatGPT (Custom GPTs)
...
```
Are you using:
- ChatGPT Pro ($200/mo) → Tier A
- ChatGPT Plus ($20/mo) → Tier B
- ChatGPT Free → Tier C
```
...
|------|------|---------|-----------|
| A (Pro) | Pro | Largest | Full Architect |
| B (Plus) | Plus | Large | Guide + Track |
